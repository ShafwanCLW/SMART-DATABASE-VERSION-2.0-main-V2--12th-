...
const KIR_SCHEMA = {
  ...
  bilangan_anak_keseluruhan: 'number',
  ...
  no_kp_pasangan_1: 'string',
  alamat_pasangan_1: 'string',
  status_pasangan_1: 'string',
  tarikh_nikah_1: 'string',
  nama_pasangan_2: 'string',
  no_kp_pasangan_2: 'string',
  alamat_pasangan_2: 'string',
  status_pasangan_2: 'string',
  tarikh_nikah_2: 'string',
  nama_pasangan_3: 'string',
  no_kp_pasangan_3: 'string',
  alamat_pasangan_3: 'string',
  status_pasangan_3: 'string',
  tarikh_nikah_3: 'string',
  nama_pasangan_4: 'string',
  no_kp_pasangan_4: 'string',
  alamat_pasangan_4: 'string',
  status_pasangan_4: 'string',
  tarikh_nikah_4: 'string',
